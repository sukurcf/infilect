...
c = conn.cursor()
for groupid in groups:
    link = f'https://api.flickr.com/services/rest/?method=flickr.urls.lookupGroup&api_key=bda33e70c77f4ff7d44d07a41c8e9fca&url=https%3A%2F%2Fwww.flickr.com%2Fgroups%2F{urllib.parse.quote(groupid)}%2F&format=json&nojsoncallback=1'
